...
namespace Tizen.NUI.Examples
{
    public class AppDetailPage : ContentPage
    {
        ...
        {
            Root.BackgroundImage = "*DemoRes*/images/store_default_bg_01.png";
        }
        ...
        private void OnFocusGained(object obj, EventArgs e)
        {
            ...
            {
                view.ResourceUrl = "*DemoRes*/images/r_highlight_bg_focus_9patch.png";
        ...
        private void OnFocusLost(object obj, EventArgs e)
        {
            ...
            if (view.Name == "DetailButton")
            {
                view.ResourceUrl = "*DemoRes*/images/c_basic_button_white_bg_normal.9.png";
