...
namespace Tizen.NUI.Examples
{
    public class InputFieldSample : IExample
    {
        ...
        private void OnCancelBtnClickEvent(object sender, NUI.Controls.InputField.CancelBtnClickArgs args)
        {
        ...
        private void OnDeleteBtnClickEvent(object sender, NUI.Controls.InputField.DeleteBtnClickArgs args)
        {
            if (sender is InputField)
            {
                InputField inputfield = sender as InputField;
        ...
        private void OnAddBtnClickEvent(object sender, NUI.Controls.InputField.AddBtnClickArgs args)
        {
            if (sender is InputField)
            {
                InputField inputfield = sender as InputField;
