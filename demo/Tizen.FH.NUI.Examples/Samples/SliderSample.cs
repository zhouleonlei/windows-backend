...
namespace Tizen.FH.NUI.Samples
{
    public class SliderSample : IExample
    {
        ...
        private void CreateDA()
        {
            ...
            slider_da[0] = CreateDA(styleName[0], 40, 100, 1000, 50, 20, Slider.DirectionType.Horizontal);
            slider_da[1] = CreateDA(styleName[0], 300, 250, 50, 400, 20, Slider.DirectionType.Vertical);
