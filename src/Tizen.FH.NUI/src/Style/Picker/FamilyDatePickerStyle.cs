...
{
    internal class FamilyDatePickerStyle : StyleBase
    {
        protected internal override Attributes GetAttributes()
        {
            ...
            PickerAttributes attributes = new PickerAttributes
            {
                ...
                FocusImageAttributes = new ImageAttributes
                {
                    ...
                    Border = new RectangleSelector { All = new Rectangle(0, 0, 1, 1) },
                    Size = new Size(80, 80),
                    ResourceURL = new StringSelector { All = CommonResource.Instance.GetFHResourcePath() + "9. Controller/[Controller] App Primary Color/picker_date_select_24c447.png" }
                },
