...
[assembly: Tizen.NUI.Xaml.XamlResourceId("Tizen.VD.NUI.res.ExSliderRenderer.xaml", "ExSliderRenderer.xaml", typeof(Tizen.VD.NUI.Renderers.ExSliderRenderer))]

namespace Tizen.VD.NUI.Renderers
{
    public class ExSliderRenderer : Tizen.NUI.Renderers.NewSliderRenderer
    {
