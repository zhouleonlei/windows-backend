...
const Vector3 _CAMERA_DEFAULT_POSITION   ( 0.0f, 0.0f, 3.0f );

// Field-of-View in degrees
const float   _CAMERA_DEFAULT_FOV        ( 60.0f );

// Near plane
const float   _CAMERA_DEFAULT_NEAR       ( 0.1f );

// Far plane
const float   _CAMERA_DEFAULT_FAR        ( 100.0f );
...
: mCameraYawPitch( 0.0f, 180.0f ),
  mFovY( _CAMERA_DEFAULT_FOV ),
  mNear( _CAMERA_DEFAULT_NEAR ),
  mFar( _CAMERA_DEFAULT_FAR ),
  mCameraPosition( _CAMERA_DEFAULT_POSITION )
{
}
