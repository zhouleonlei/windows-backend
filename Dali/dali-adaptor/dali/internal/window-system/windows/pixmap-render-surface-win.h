 ...
 */
class PixmapRenderSurfaceWin : public PixmapRenderSurface
{
public:
  ...
  /**
    ...
    */
  PixmapRenderSurfaceWin( Dali::PositionSize positionSize, Any surface, bool isTransparent = false );

  /**
   * @brief Destructor
   */
  virtual ~PixmapRenderSurfaceWin();
