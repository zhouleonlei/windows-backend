...
PixmapRenderSurfaceWin::PixmapRenderSurfaceWin( Dali::PositionSize positionSize, Any surface, bool isTransparent )
...
PixmapRenderSurfaceWin::~PixmapRenderSurfaceWin()
{
...
void PixmapRenderSurfaceWin::Initialize( Any surface )
{
...
Any PixmapRenderSurfaceWin::GetSurface()
{
...
void PixmapRenderSurfaceWin::SetRenderNotification(TriggerEventInterface* renderNotification)
{
  mRenderNotification = renderNotification;
}

PositionSize PixmapRenderSurfaceWin::GetPositionSize() const
{
  return mPosition;
}

void PixmapRenderSurfaceWin::GetDpi( unsigned int& dpiHorizontal, unsigned int& dpiVertical )
{
  // calculate DPI 
  float xres, yres;
...
void PixmapRenderSurfaceWin::InitializeEgl( EglInterface& egl )
{
...
void PixmapRenderSurfaceWin::CreateEglSurface( EglInterface& egl )
{
  DALI_LOG_TRACE_METHOD( gPixmapRenderSurfaceLogFilter );
...
void PixmapRenderSurfaceWin::DestroyEglSurface( EglInterface& egl )
{
  DALI_LOG_TRACE_METHOD( gPixmapRenderSurfaceLogFilter );
...
bool PixmapRenderSurfaceWin::ReplaceEGLSurface( EglInterface& egl )
{
  DALI_LOG_TRACE_METHOD( gPixmapRenderSurfaceLogFilter );
...
void PixmapRenderSurfaceWin::StartRender()
{
}

bool PixmapRenderSurfaceWin::PreRender( EglInterface& egl, Integration::GlAbstraction&, bool )
{
  // Nothing to do for pixmaps
  return true;
}

void PixmapRenderSurfaceWin::PostRender( EglInterface& egl, Integration::GlAbstraction& glAbstraction, Dali::DisplayConnection* displayConnection, bool replacingSurface, bool resizingSurface )
{
}

void PixmapRenderSurfaceWin::StopRender()
{
  ReleaseLock();
}

void PixmapRenderSurfaceWin::SetThreadSynchronization( ThreadSynchronizationInterface& threadSynchronization )
{
  mThreadSynchronization = &threadSynchronization;
}

void PixmapRenderSurfaceWin::ReleaseLock()
{
...
RenderSurface::Type PixmapRenderSurfaceWin::GetSurfaceType()
{
  return RenderSurface::PIXMAP_RENDER_SURFACE;
}

void PixmapRenderSurfaceWin::CreateRenderable()
{
}

void PixmapRenderSurfaceWin::UseExistingRenderable( unsigned int surfaceId )
{
}

unsigned int PixmapRenderSurfaceWin::GetSurfaceId( Any surface ) const
{
  return 0;
}
